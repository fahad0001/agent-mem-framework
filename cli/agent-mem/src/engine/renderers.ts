...
const aiderRenderer: VendorRenderer = {
  ...
  render(agents, ctx) {
    ...
    const md = [
      "# Aider Conventions (auto-generated by agent-mem)",
      "",
      "This file aggregates the agent-mem framework's neutral agent",
      "definitions for the Aider AI coding assistant. Do not edit by hand;",
      "regenerate via `agent-mem repair`.",
      "",
      ctx.ahcBlock,
      "",
      ...sections,
